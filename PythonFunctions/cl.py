...
os.system("~/whisk/bin/wsk -i action create prime512 primeNumber.py -m 512 -t 300000")
sleep(delay)
os.system("~/whisk/bin/wsk -i action create prime256 primeNumber.py -m 256 -t 300000")
sleep(delay)
os.system("~/whisk/bin/wsk -i action create prime128 primeNumber.py -m 128 -t 300000")
sleep(delay)

os.system("~/whisk/bin/wsk -i action create factorial512 factorial.py -m 512 -t 300000")
sleep(delay)
os.system("~/whisk/bin/wsk -i action create factorial256 factorial.py -m 256 -t 300000")
sleep(delay)
os.system("~/whisk/bin/wsk -i action create factorial128 factorial.py -m 128 -t 300000")
sleep(delay)

os.system("~/whisk/bin/wsk -i action create fib512 fibonacci.py -m 512 -t 300000")
sleep(delay)
os.system("~/whisk/bin/wsk -i action create fib256 fibonacci.py -m 256 -t 300000")
sleep(delay)
os.system("~/whisk/bin/wsk -i action create fib128 fibonacci.py -m 128 -t 300000")
sleep(delay)

os.system("~/whisk/bin/wsk -i action create matrix512 matrix.py -m 512 -t 300000")
sleep(delay)
os.system("~/whisk/bin/wsk -i action create matrix256 matrix.py -m 256 -t 300000")
sleep(delay)
os.system("~/whisk/bin/wsk -i action create matrix128 matrix.py -m 128 -t 300000")
sleep(delay)

os.system("~/whisk/bin/wsk -i action create delay512 delay.py -m 512 -t 300000")
sleep(delay)
os.system("~/whisk/bin/wsk -i action create delay256 delay.py -m 256 -t 300000")
sleep(delay)
os.system("~/whisk/bin/wsk -i action create delay128 delay.py -m 128 -t 300000")
sleep(delay)

os.system("~/whisk/bin/wsk -i action create memory512 memory.py -m 512 -t 300000")
sleep(delay)
os.system("~/whisk/bin/wsk -i action create memory256 memory.py -m 256 -t 300000")
sleep(delay)
os.system("~/whisk/bin/wsk -i action create memory128 memory.py -m 128 -t 300000")
sleep(delay)
